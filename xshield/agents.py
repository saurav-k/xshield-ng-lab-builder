...
agent_version_api = f'{domain}/api/agents/versions'
deployment_key_api = f'{domain}/api/deployment-keys'
...
def get_deployment_key():
    ...
    raise Exception("Unable to fetch deployment key.  Check configuaration")
